...
public:
	...
	// distribucion Uniforme [0,1] para la probabilidad del thining method
	eosim::dist::UniformDist distProbThinning;
	...
	void cambiarFila(Cliente* cliente, unsigned int cajaElegida);
};
