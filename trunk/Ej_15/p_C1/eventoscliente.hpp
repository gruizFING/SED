...
// identificador del evento fijo QueueSwopping
const std::string queueC = "QueueSwopping";

class QueueSwopping: public eosim::core::BEvent {
public:
	// constructor
	QueueSwopping(eosim::core::Model& model);
	// destructor
	~QueueSwopping();
	// rutina del evento fijo
	void eventRoutine(eosim::core::Entity* who);
