...
int main () {
    ...
    double tiempoServicioM1 = tiempoServicioM, tiempoServicioS1 = tiempoServicioS;
    std::string s;
    ...
    for (unsigned int i = 1; i <= repeticiones; i++) {
        ...
        Banco b(cantCajas, cajasSoloRetiro, tiempoEntreArribos,
                tiempoServicioM1, tiempoServicioS1);
        Experiment e;
        b.connectToExp(&e);
    ...
    using namespace std;
    cout << "Tiempo de cada simulacion: " << minutosSimulacionMin << " minutos. Numero de repeticiones: " << repeticiones << ". " << std::endl << std::endl;
