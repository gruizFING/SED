...
public:
	...
	// distribucion LogNormal para el tiempo de servicio de todas las cajas
	eosim::dist::LogNormalDist distTiempoServicio;
	...
	Banco(unsigned int cantCajas, bool cajasSoloRetiro[], double tiempoEntreArribos,
