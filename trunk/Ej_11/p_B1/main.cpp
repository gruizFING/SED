...
int main () {
    ...
    std::cout << "Tiempo de cada simulacion: " << minutosSimulacionMin << " minutos. Numero de repeticiones: " << repeticiones << ". " << endl << endl;
    std::cout << "Media x para los tiempos de espera: " << x_espera << endl;
    std::cout << "Desviacion s para los tiempos de espera: " << s_espera << endl << endl;
    std::cout << "Media x para la cantidad de clientes: " << x_cantClientes << endl;
    std::cout << "Desviacion s para la cantidad de clientes: " << s_cantClientes << endl << endl;
    std::cout << "Media x para los largos de las colas: " << x_largoColas << endl;
    std::cout << "Desviacion s para los largos de las colas: " << s_largoColas << endl << endl;

    // Calculo de intervalos de confianza para las medias
    std::cout << "Intervalo al 95% para los tiempos de espera" << endl;
    std::cout << x_espera - 2.045 * (s_espera / sqrt(repeticiones)) << " < Mu < " << x_espera + 2.045 * (s_espera / sqrt(repeticiones)) << endl;
    std::cout << "Intervalo al 99% para los tiempos de espera"<< endl;
    std::cout << x_espera - 2.756 * (s_espera / sqrt(repeticiones)) << " < Mu < " << x_espera + 2.756 * (s_espera / sqrt(repeticiones)) << endl << endl;

    std::cout << "Intervalo al 95% para la cantidad de clientes" << endl;
    std::cout << x_cantClientes - 2.045 * (s_cantClientes / sqrt(repeticiones)) << " < Mu < " << x_cantClientes + 2.045 * (s_cantClientes / sqrt(repeticiones)) << endl;
    std::cout << "Intervalo al 99% para la cantidad de clientes"<< endl;
    std::cout << x_cantClientes - 2.756 * (s_cantClientes / sqrt(repeticiones)) << " < Mu < " << x_cantClientes + 2.756 * (s_cantClientes / sqrt(repeticiones)) << endl << endl;

    std::cout << "Intervalo al 95% para los largos de las colas" << endl;
    std::cout << x_largoColas - 2.045 * (s_largoColas / sqrt(repeticiones)) << " < Mu < " << x_largoColas + 2.045 * (s_largoColas / sqrt(repeticiones)) << endl;
    std::cout << "Intervalo al 99% para los largos de las colas"<< endl;
    std::cout << x_largoColas - 2.756 * (s_largoColas / sqrt(repeticiones)) << " < Mu < " << x_largoColas + 2.756 * (s_largoColas / sqrt(repeticiones)) << endl << endl;
